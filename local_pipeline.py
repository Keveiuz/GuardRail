...
llm_config = LocalInferenceGenerator.LLMConfig(
    model="/data/pretrained_models/Qwen3/Qwen3-8B",
    tensor_parallel_size=1,
)
sampling_config = LocalInferenceGenerator.SamplingConfig()
ray_config = LocalInferenceGenerator.RayConfig(num_actors=2, num_gpus=2)
...
sampling_config = LocalInferenceGenerator.SamplingConfig()
ray_config = LocalInferenceGenerator.RayConfig(num_actors=1, num_gpus=2)
...
for loader in [wildguard_loader]:
    ...
    synth_judgement = synth_engine.generate(
